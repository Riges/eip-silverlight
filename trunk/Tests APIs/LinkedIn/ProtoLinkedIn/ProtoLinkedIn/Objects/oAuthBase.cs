...
namespace ProtoLinkedIn.Objects
{
    public class oAuthBase
    {
        ...
        private string ComputeHash(HashAlgorithm hashAlgorithm, string data)
        {
            ...
            wcf.getEncodeASCIICompleted += new EventHandler<getEncodeASCIICompletedEventArgs>(wcf_getEncodeASCIICompleted);
            wcf.getEncodeASCIIAsync(data);
            byte[] hashBytes = hashAlgorithm.ComputeHash(dataBuffer);

            return Convert.ToBase64String(hashBytes);
        }

        static void wcf_getEncodeASCIICompleted(object sender, getEncodeASCIICompletedEventArgs e)
        {
            if (e.Result != null)
            {
            }
